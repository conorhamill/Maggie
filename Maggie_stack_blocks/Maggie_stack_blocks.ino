...
void loop() 
{
  ...
  //first block
  x_axis_move(10);  main_arm.move(0,-20);  grip.close();  main_arm.home();
  
  x_axis_move(40);  main_arm.move(0,-20);  grip.open();  main_arm.home();

  //second block
  x_axis_move(20);  main_arm.move(0,-20);  grip.close();  main_arm.home();
  
  x_axis_move(40);  main_arm.move(0,-19);  grip.open();  main_arm.home();

  //third block
  x_axis_move(30); main_arm.move(0,-20);  grip.close();  main_arm.home();

  x_axis_move(40);  main_arm.move(0,-18);  grip.open();  main_arm.home();

  //home position
  return_home();

  //third block
  x_axis_move(40);  main_arm.move(0,-18);  grip.close();  main_arm.home();  
  
  x_axis_move(30);  main_arm.move(0,-20);  grip.open();  main_arm.home();

  //second block
  x_axis_move(40);  main_arm.move(0,-19);  grip.close();  main_arm.home();  
  
  x_axis_move(20);  main_arm.move(0,-20);  grip.open();  main_arm.home();

  //first block
  x_axis_move(40);  main_arm.move(0,-20);  grip.close();  main_arm.home();  
  
  x_axis_move(10);  main_arm.move(0,-20);  grip.open();  main_arm.home();  
