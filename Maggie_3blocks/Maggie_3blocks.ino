...
void loop() 
{
  ...
  //first lift
  x_axis_move(10);  main_arm.move(-4,-20);  grip.close();  main_arm.home();
  
  x_axis_move(50);  main_arm.move(-4,-20);  grip.open();  main_arm.home();

  //second lift
  main_arm.move(4,-20);  grip.close();  main_arm.home();
  
  x_axis_move(10);  main_arm.move(4,-20);  grip.open();  main_arm.home();

  //third lift
  x_axis_move(30); main_arm.move(-4,-20);  grip.close();  main_arm.home();

  main_arm.move(4,-20);  grip.open();  main_arm.home();

  //fourth lift
  x_axis_move(50);  main_arm.move(-4,-20);  grip.close();  main_arm.home();
